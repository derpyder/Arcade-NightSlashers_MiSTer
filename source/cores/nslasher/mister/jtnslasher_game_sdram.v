...
`endif
    ...
    .p4     ( 30'h0), 
    .p5     ( 30'h0), 
    // AUDIO BALANCE (2026-07-02, v1.0a): the nf25 "round 2" mem.yaml rsum edits (fm 90k / oki2 110k)
    // NEVER reached a build -- this generated file predates them and every nf25..v1.0 build was a
    // Windows-only Quartus recompile (no WSL regeneration). The user heard the old mix throughout.
    // Values below are hand-set (this file is what compiles; cfg/mem.yaml documents the intent):
    // fm 0x29->0x14 (music x0.49, the twice-requested cut), oki2 0x1E->0x23 (quiet-SFX raise).
    .g0     ( 8'h14 ), // 0.16  fm (YM2151 music)
    .g1     ( 8'h80 ), // 1.00  oki1 (SFX/voice anchor)
    .g2     ( 8'h23 ), // 0.27  oki2
    .g3     ( 8'h00 ), // 0.00 
    .g4     ( 8'h00 ), // 0.00 
    .g5     ( 8'h00 ), // 0.00 
