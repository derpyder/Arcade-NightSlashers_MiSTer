...
iverilog -g2012 -I . -I "$CORE" -I "$GFX" -o tb_objfold_real_probe.vvp \
  tb_objfold_real_probe.v $CORE/jtnslasher_sdram.v $CORE/jtnslasher_gfxdec.v \
