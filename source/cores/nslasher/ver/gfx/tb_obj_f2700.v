...
// If frame_obj_f2700.hex == golden_obj_f2700.hex (0 diffs) -> decode is correct for tall in-game
...
module tb_obj_f2700;
    ...
    initial begin
        ...
        f=$fopen("frame_obj_f2700.hex","w");
        for(i=0;i<76800;i=i+1) $fwrite(f,"%04x\n", fb[i]);
        $fclose(f);
        $display("tb_obj_f2700: 240 lines -> frame_obj_f2700.hex");
        $finish;
    end
endmodule
