...
module tb_obj_f2700_lat;
    ...
    integer maxlc=0, maxwe=0, maxwe_ln=0, maxwe_lc=0;
    initial begin
        ...
        for(ln=0; ln<240; ln=ln+1) begin
            ...
            if (u_dut.line_cnt > maxlc) maxlc = u_dut.line_cnt;
            if (last_we_cyc > maxwe) begin maxwe = last_we_cyc; maxwe_ln = ln; maxwe_lc = u_dut.line_cnt; end
        ...
        $display("  PROBE: max line_cnt=%0d ; busiest line %0d had line_cnt=%0d last_we_cyc=%0d", maxlc, maxwe_ln, maxwe_lc, maxwe);
